...
export const possibleBotNames = ["thymo", "Mystic", "Prime", "Temu", "Superlab", "LuberSab", "rank 35", "Fear My Prime.", "tomar753", "Charlie Kurk", "Hallo", "free leon", "ваня кек", "smw1", "Luna", "Hyra", "Juan Carlos", "Pituś", "Blast", "JordiTheCat", "TID_BOT_67", "Switly", "Tufa", "Trypix"];
